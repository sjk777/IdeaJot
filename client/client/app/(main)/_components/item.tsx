    ...
    return(
        ...
        >
            ...
            {!!id && (
                <div
                role="button"
                className="h-full rounded-sm hover:bg-neutral-300 dark:bg-netural-600 mr-1"
                onClick={() => {}}
                >
                    <ChevronIcon
                        className="h-4 w-4 shrink-0 text-muted-foregounr/50"
                    />
                </div>
            )}
            {documentIcon ? (
            ...
            {isSearch && (
                ...
                font-mono text-[10px] front-medium text-muted-foreground opacity-100">
            ...
            {!!id &&(
                // second div will only show in the group-hover category when we are hovered over the section
